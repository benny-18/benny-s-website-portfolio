...
export const Footer = () => {
    return <section className="bg-teal-main w-full h-auto">
        <div className="relative w-full flex flex-col md:flex-row gap-12 md:gap-0 justify-between">
            ...
            <div className="basis-1/3 flex flex-col items-center gap-0 md:border-r-2 border-b-2 p-10">
                ...
                <p className="text-base text-xl font-space text-start font-normal my-2"> Developer and designer.</p>
                <Button className="font-space bg-orange-main w-fit my-2">
                    <Send />
                    Contact now
                </Button>
            </div>
            ...
            <div className="basis-1/3 flex flex-col gap-0 border-b-2 p-10">

            </div>
        </div>

        <div className="h-auto md:border-t-0 flex flex-col md:flex-row items-center justify-between px-10 p-12 gap-4">
            <p className="text-center text-base font-space">© 2026 Marvin Masubay. All rights reserved.</p>
