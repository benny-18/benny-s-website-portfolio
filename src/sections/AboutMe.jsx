    ...
    return <section className="relative bg-dotted bg-background w-full overflow-x-hidden flex flex-col items-center">
        <div className="relative w-full">
            ...
            <div className="flex items-center justify-center p-10 md:p-20">
                <div className="h-fit max-w-[80vw] md:max-w-[50vw] flex flex-col md:items-center justify-center">
                    <h1 className="text-5xl md:text-7xl font-extrabold font-barlow uppercase leading-none tracking-tight pb-4">ABOUT THE DEV</h1>
                    <a className="text-base relative z-10 md:text-xl md:text-center font-space font-normal md:px-16 pb-6">
                    ...
                    <div className="relative flex flex-col md:flex-row gap-6 pb-6">
                        <Button className="basis-3/7 bg-fuschia-main w-full h-auto flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                            <p className="font-barlow font-bold text-xl pb-1">ABOUT MARVIN</p>
                            <p className="font-dm text-base">
                                I am Marvin Masubay. I am passionate about exploring cross-platform development and modern front-end web design.
                            </p>
                        </Button>
                        ...
                        <Button className="basis-2/7 w-full bg-yellow-main h-auto flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                            <p className="font-barlow font-bold text-xl pb-1">EDUCATION</p>
                            <p className="font-dm text-base">
                        ...
                        <Button className="basis-2/7  bg-lime-main w-full h-auto flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                            <p className="font-barlow font-bold text-xl pb-1">LOCATION</p>
                            <p className="font-dm text-base">
                    ...
                    <div className="relative flex flex-col md:flex-row gap-6 pb-6">
                        <Button className="basis-2/7 w-full bg-orange-main h-auto flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                            <p className="font-barlow font-bold text-xl pb-1">CORE PHILOSOPHY</p>
                            <p className="font-dm text-base">
                        ...
                        <div className="basis-5/7 flex flex-col gap-6">
                            ...
                            <div className="basis-3/5 w-full h-auto items-start justify-center whitespace-normal text-left flex flex-col md:flex-row gap-6">
                                <Button className="basis-3/5 w-full bg-teal-main h-full flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                                    <p className="font-barlow font-bold text-xl pb-1">DOMAIN EXPERTISE</p>
                                    <p className="font-dm text-base">
                                ...
                                <Button className="basis-2/5 bg-fuschia-main w-full h-full flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                                    <p className="font-barlow font-bold text-xl pb-1">CREATIVE TOOLS</p>
                                    <p className="font-dm text-base">
                            ...
                            <div className="basis-3/5 w-full h-full items-start justify-between whitespace-normal text-left flex flex-col md:flex-row gap-6">
                                <Button className="basis-2/5 w-full bg-rose-main h-auto flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                                    <p className="font-barlow font-bold text-xl pb-1">TECH STACK</p>
                                    <p className="font-dm text-base">
                                ...
                                <Button className="basis-3/5 w-full h-full bg-sky-main flex flex-col items-start justify-between whitespace-normal text-left gap-0">
                                    <p className="font-barlow font-bold text-xl pb-1">CURRENT FOCUS</p>
                                    <p className="font-dm text-base">
                                        Deep diving into the Vite, React, and Tailwind CSS ecosystem to build my personal website portfolio.
                                    </p>
                                </Button>
                            </div>
